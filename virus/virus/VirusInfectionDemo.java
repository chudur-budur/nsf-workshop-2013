...
public /*strictfp*/ class VirusInfectionDemo extends SimState
{
	...
	public static double DIAMETER = 8;

	public static double HEALING_DISTANCE = 20;
	public static final double HEALING_DISTANCE_SQUARED = HEALING_DISTANCE * HEALING_DISTANCE;
	public static double INFECTION_DISTANCE = 20;
	...
	public static int NUM_GOODS = 4;
	public static int NUM_EVILS = 4;

	public Continuous2D environment = null;

	// to access the model statistics
	public Human[] humans = new Human[NUM_HUMANS];	
	...
	// This procedure returns the fitness of the model.
	// Currently, the fitness is the % of people infected, 
	// the ECJ will try to minimize it.
	// This function needs to be removed from here and 
	// to be put into some sort of interface.
	// So that this could be made generic to all sorts
	// of simulations.
	public double getModelFitness()
	{
		...
		for(int i = 0 ; i < humans.length ; i++)
			if(humans[i].isInfected())
				infected++ ;
		return infected/(double)humans.length ;
	}
