...
import ec.app.mason.pacman.PolicyStep ;
...
public abstract class Agent implements Oriented2D
{
	...
	/** A flag to keep track if the agent is moving or stuck **/
	...
	/** 
	 * The agent has a policy step, this encapsulates an agent's behaviour,
	 * This can be implemented such that it could use user keyboard input, 
	 * or a GP tree, or an RL techniques like Q-Learning, TD-Learning; 
	 * -- whatever you like.
	 * -- this is defined just after the Pac instantiation. 
	 *    See the main() procedure in the PacManWithUI.java.
	 **/	
	protected PolicyStep policyStep = null ;
	...
	/**
	 * Sets the policy step object.
	 **/
	public void setPolicyStep(PolicyStep ps)
	{
		this.policyStep = ps ;
	}

	/** 
	 * Resets an agent, to avoid the "new" memory allocation 
	 * in the resetAgents() procedure; From now on, "new" will 
	 * be only called in the constructors.
	 **/
	public void reset()
	{
		Double2D loc = getStartLocation();
	...
	/** Checks if the agent is stuck or not, updated in the step() methods **/
